...
(function() {
  var $map, WAudio, autocomplete, destination, directionsRenderer, home, map, navigationMode, normalMap, rotationMap, route, say, startWatch, watchId;
  ...
  say = function(string) {
    ...
    MAX_LENGTH = 100;
    audio = new WAudio("translate_tts?tl=" + lang + "&q=" + (encodeURIComponent(string.slice(0, MAX_LENGTH))));
    return audio.play();
  };
