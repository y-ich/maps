...
(function() {
  var $gps, $map, $mapframe, destinationMarker, droppedMarker, geocoder, getLocationHandler, image, map, myOptions, pulsatingMarker, squareSize, startMarker, traceHandler, traceHeadingEnable, watchId;
