...
(function() {
  var $destination, $origin, directionsRenderer, droppedInfo, droppedMarker, geocodeHandler, geocoder, getLocationHandler, getMapType, getTravelMode, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapSum, meterToString, naviMarker, navigate, pulsatingMarker, saveStatus, searchDirections, secondToString, traceHandler;
