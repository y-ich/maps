...
(function() {
  var $destination, $gps, $map, $origin, MapFSM, MapState, bookmarkContext, directionsRenderer, droppedInfo, droppedMarker, geocodeHandler, geocoder, getLocationHandler, getMapType, getTravelMode, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapFSM, mapSum, meterToString, naviMarker, navigate, pulsatingMarker, saveStatus, searchDirections, secondToString, traceHandler, traceState;
  ...
  MapState = (function() {
    ...
    MapState.NORMAL = new MapState();

    MapState.TRACE_POSITION = new MapState();

    MapState.TRACE_HEADING = new MapState();
  ...
  MapState.NORMAL.update = function() {
    ...
    return $gps.removeClass('btn-primary');
  };
  ...
  MapState.TRACE_HEADING.update = function() {
    return traceHandler.heading = true;
  };
  ...
  MapFSM = (function() {
    ...
    MapFSM.prototype.gpsClicked = function() {
      return this.setState(this.state.gpsClicked());
    };

    MapFSM.prototype.moved = function() {
      return this.setState(this.state.moved());
    };

    MapFSM.prototype.bookmarkClicked = function() {
      return this.setState(this.state.bookmarkClicked());
    };

    MapFSM.prototype.currentPositionClicked = function() {
      return this.setState(this.state.currentPositionClicked());
    };
