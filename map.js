...
(function() {
  var $gps, $map, destinationMarker, droppedMarker, geocoder, getLocationHandler, image, map, myOptions, pulsatingMarker, squareSize, startMarker, traceHandler, traceHeadingEnable, watchId;
