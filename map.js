...
(function() {
  var $destination, $gps, $map, $origin, Bookmark, MapFSM, MapState, PURPLE_DOT_IMAGE, RED_DOT_IMAGE, WatchPosition, bookmarkContext, bookmarks, currentBookmark, directionsRenderer, droppedBookmark, geocodeHandler, geocoder, getMapType, getPanoramaHandler, getTravelMode, infoWindow, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapFSM, mapSum, meterToString, method, name, naviMarker, navigate, pulsatingMarker, routeHistory, saveStatus, searchDirections, searchHistory, secondToString, setInfoPage, traceHandler, _ref;
