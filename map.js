...
(function() {
  var $destination, $gps, $map, $origin, MapFSM, MapState, PURPLE_DOT_IMAGE, RED_DOT_IMAGE, bookmarkContext, bookmarks, directionsRenderer, droppedGeocoderResult, droppedMarker, geocodeHandler, geocoder, getLocationHandler, getMapType, getTravelMode, infoWindow, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapFSM, mapSum, meterToString, method, name, naviMarker, navigate, pulsatingMarker, routeHistory, saveStatus, searchDirections, searchHistory, secondToString, setInfoPage, traceHandler, watchId, _ref;
  ...
  setInfoPage = function(geocoderResult, deleteButton) {
