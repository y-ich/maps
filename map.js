...
(function() {
  var $destination, $origin, directionsRenderer, directionsService, geocoder, initializeDOM, initializeGoogleMaps, map, pulsatingMarker, saveStatus, searchDirections, traceHandler, traceHeadingEnable, travelMode, watchId;
