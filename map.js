...
(function() {
  var $destination, $origin, deocoder, directionsRenderer, droppedInfo, droppedMarker, geocodeHandler, getLocationHandler, getMapType, getTravelMode, initializeDOM, initializeGoogleMaps, map, mapSum, meterToString, naviMarker, navigate, pulsatingMarker, saveStatus, searchDirections, secondToString, traceHandler;
  ...
  initializeGoogleMaps = function() {
    ...
    google.maps.event.addListener(map, 'click', function(event) {
      ...
      return geocoder.geocode({
        ...
        if (status === google.maps.GeocoderStatus.OK) {
          return $('#dropped-message').text(result[0].formatted_address.replace(/日本, /, '').replace(/.*〒[\d-]+/, ''));
        } else {
          return $('#dropped-message').text('ドロップされたピン</br>情報がみつかりませんでした。');
        }
      });
    });
