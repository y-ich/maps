...
(function() {
  var $destination, $origin, directionsRenderer, droppedMarker, geocodeHandler, getMapType, getTravelMode, initializeDOM, initializeGoogleMaps, map, mapSum, meterToString, naviMarker, navigate, pulsatingMarker, saveStatus, searchDirections, secondToString, traceHandler;
  ...
  initializeGoogleMaps = function() {
    var destinationMarker, getLocationHandler, last, mapOptions, startMarker;
    mapOptions = {
