...
(function() {
  var $destination, $gps, $map, $origin, MapFSM, MapState, PURPLE_DOT_IMAGE, RED_DOT_IMAGE, bookmarkContext, bookmarks, directionsRenderer, droppedInfo, droppedMarker, geocodeHandler, geocoder, getLocationHandler, getMapType, getTravelMode, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapFSM, mapSum, meterToString, method, name, naviMarker, navigate, pulsatingMarker, routeHistory, saveStatus, searchDirections, searchHistory, secondToString, traceHandler, watchId, _ref;
