...
(function() {
  var $addressField, $destinationField, $gps, $map, $originField, $pinList, Bookmark, DEFAULT_ICON_SIZE, MSMARKER_SHADOW, MapFSM, MapState, MobileInfoWindow, PURPLE_DOT_IMAGE, RED_DOT_IMAGE, WatchPosition, bookmarkContext, bookmarks, currentBookmark, directionsRenderer, droppedBookmark, generateBookmarkList, generateHistoryList, geocoder, getLocalizedString, getMapType, getPanoramaHandler, getTravelMode, history, infoWindow, initializeDOM, initializeGoogleMaps, isHold, localize, makeInfoMessage, map, mapFSM, mapSum, maxHistory, meterToString, method, name, naviMarker, navigate, pinRowHeight, pulsatingMarker, saveMapStatus, saveOtherStatus, searchAddress, searchBookmark, searchDirections, secondToString, setInfoPage, setLocalExpressionInto, sum, traceHandler, updateField, _ref, _ref1,
  ...
  localize = function() {
    ...
    return setLocalExpressionInto('save-bookmark', 'Save');
  };
