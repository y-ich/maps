...
(function() {
  var $destination, $gps, $map, $origin, Bookmark, MapFSM, MapState, PURPLE_DOT_IMAGE, RED_DOT_IMAGE, WatchPosition, bookmarkContext, bookmarks, currentBookmark, directionsRenderer, droppedBookmark, geocodeHandler, geocoder, getMapType, getPanoramaHandler, getTravelMode, history, infoWindow, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapFSM, mapSum, meterToString, method, name, naviMarker, navigate, pulsatingMarker, saveMapStatus, saveOtherStatus, searchDirections, secondToString, setInfoPage, traceHandler, _ref;
  ...
  initializeDOM = function() {
    var $edit, $mapType, $navi, $option, $route, $routeSearchFrame, $search, $traffic, $travelMode, $versatile, backToMap, e, otherStatus, pinRowHeight, trafficLayer, watchPosition, _i, _len, _ref1, _ref2, _ref3;
    $origin = $('#origin');
