...
(function() {
  var $destination, $gps, $map, $origin, MapFSM, MapState, bookmarkContext, directionsRenderer, droppedInfo, droppedMarker, geocodeHandler, geocoder, getLocationHandler, getMapType, getTravelMode, initializeDOM, initializeGoogleMaps, makeInfoMessage, map, mapFSM, mapSum, meterToString, method, name, naviMarker, navigate, pulsatingMarker, saveStatus, searchDirections, secondToString, traceHandler, _ref;
