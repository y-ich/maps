...
(function() {
  var CLIENT_ID, Event, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, authorizeFunction, events, geocoder, getLocalizedString, getTimeZone, handleAuthResult, handleClientLoad, initializeDOM, initializeGoogleMaps, localTime, localize, map, saveMapStatus, setLocalExpressionInto, timeDifference,
    _this = this;
  ...
  Place = (function() {
    ...
    Place.prototype._setInfo = function() {
      ...
      if ((this.event.resource.start.date != null) && (this.event.resource.end.date != null)) {
        ...
        $('#form-event input[name="all-day"]').trigger('change');
        getTimeZone(new Date(this.event.resource.start.dateTime), this.marker.getPosition(), function(obj) {
          var dateTime;
        ...
        getTimeZone(new Date(this.event.resource.end.dateTime), this.marker.getPosition(), function(obj) {
          var dateTime;
