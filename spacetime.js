...
(function() {
  var CLIENT_ID, MAP_STATUS, MarkerWithCircle, MobileInfoWindow, SCOPES, authorizeFunction, geocoder, getLocalizedString, handleAuthResult, handleClientLoad, initializeDOM, initializeGoogleMaps, localize, map, markers, method, name, saveMapStatus, setLocalExpressionInto, _ref,
  ...
  initializeDOM = function() {
    ...
    return $('#button-show').on('click', function(event) {
      ...
      return req.execute(function(resp) {
        var count, e, match, _i, _len, _ref1, _results;
        count = 0;
        if (resp.error != null) {
          ...
          for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
            ...
            if (e.location != null) {
              if (match = e.location.match(/\((\d*\.\d*)\s*,\s*(\d*\.\d*)\)/)) {
                _results.push(markers.push(new google.maps.Marker({
                  map: map,
                ...
                _results.push(console.log('too many for geocode.'));
              }
            } else {
