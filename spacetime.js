...
(function() {
  var CLIENT_ID, DEFAULT_ICON_SIZE, Event, MAP_STATUS, MarkerWithCircle, MobileInfoWindow, SCOPES, authorizeFunction, events, geocoder, getLocalizedString, handleAuthResult, handleClientLoad, infoWindow, initializeDOM, initializeGoogleMaps, localize, map, method, name, saveMapStatus, setLocalExpressionInto, style, _ref,
  ...
  Event = (function() {
    ...
    Event.prototype.latLng = function() {
      var match, _ref1;
      if (match = (_ref1 = this.resource.location) != null ? _ref1.match(/\((\d*\.\d*)\s*,\s*(\d*\.\d*)\)/) : void 0) {
    ...
    Event.prototype.geocode = function(callback) {
      ...
      return geocoder.geocode({
        ...
        if (status === google.maps.GeocoderStatus.OK) {
          if (results.length === 1) {
            _this.resource.location += results[0].geometry.location.toString();
            ...
            req.execute(function(resp) {
              if (resp.error != null) {
                ...
                return console.log('update succeed');
              }
            });
            return callback();
          } else {
