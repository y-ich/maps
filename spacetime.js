...
(function() {
  ...
  Event = (function() {
    ...
    Event.prototype.setPlace = function() {
      var latLng, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (!((this.resource.location != null) && this.resource.location !== '')) {
        return null;
      }
      latLng = this.latLng();
      ...
      console.log((_ref1 = (_ref2 = this.resource.start.date) != null ? _ref2 : this.resource.start.dateTime) != null ? _ref1 : '');
      return this.place = new Place({
        map: map,
        position: latLng,
        icon: (_ref3 = this.icon) != null ? _ref3 : null,
        shadow: this.icon != null ? Event.shadow : null,
        title: this.resource.location
      }, "<h5>" + this.resource.summary + "</h5>\n<dl class=\"dl-horizontal\">\n    <dt>Location</dt>\n    <dd>" + ((_ref4 = this.resource.location) != null ? _ref4 : '') + "</dd>\n    <dt>Start</dt>\n    <dd>" + (((_ref5 = (_ref6 = this.resource.start.date) != null ? _ref6 : this.resource.start.dateTime) != null ? _ref5 : '') + ((_ref7 = this.resource.start.timeZone) != null ? _ref7 : timeZone(this.calendarId))) + "</dd>\n    <dt>End</dt>\n    <dd>" + (((_ref8 = (_ref9 = this.resource.end.date) != null ? _ref9 : this.resource.end.dateTime) != null ? _ref8 : '') + ((_ref10 = this.resource.start.timeZone) != null ? _ref10 : timeZone(this.calendarId))) + "</dd>\n    <dt>Description</dt>\n    <dd>" + ((_ref11 = this.resource.description) != null ? _ref11 : '') + "</dd>\n</dl>");
    };
    ...
    Event.prototype.tryToSetPlace = function() {
      ...
      if (!this.setPlace()) {
        return this.geocode(function(results) {
          var e, _i, _len, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
          if (!_this.setPlace()) {
            _this.candidates = [];
            for (_i = 0, _len = results.length; _i < _len; _i++) {
              ...
              _this.candidates.push(new Place({
                ...
                optimized: false
              }, "<h5>" + _this.resource.summary + "</h5>\n<dl class=\"dl-horizontal\">\n    <dt>Location</dt>\n    <dd>" + ((_ref2 = _this.resource.location) != null ? _ref2 : '') + "</dd>\n    <dt>Here is</dt>\n    <dd>" + e.formatted_address + "</dd>\n    <dt>Start</dt>\n    <dd>" + (((_ref3 = (_ref4 = _this.resource.start.date) != null ? _ref4 : _this.resource.start.dateTime) != null ? _ref3 : '') + ((_ref5 = _this.resource.start.timeZone) != null ? _ref5 : '')) + "</dd>\n    <dt>End</dt>\n    <dd>" + (((_ref6 = (_ref7 = _this.resource.end.date) != null ? _ref7 : _this.resource.end.dateTime) != null ? _ref6 : '') + ((_ref8 = _this.resource.start.timeZone) != null ? _ref8 : '')) + "</dd>\n    <dt>Description</dt>\n    <dd>" + ((_ref9 = _this.resource.description) != null ? _ref9 : '') + "</dd>\n</dl>"));
            }
            return setTimeout((function() {
