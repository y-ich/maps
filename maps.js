...
(function() {
  ...
  Place = (function() {
    ...
    Place.streetViewButtonWrapper = $('<div class="button-wrapper wrapper-left"></div>').on('click', function() {
      ...
      if (placeContext.svLatLng != null) {
        $map.addClass('streetview').css('top', '').css('height', '');
  ...
  fitMapBewteenHeaderAndFooter = function() {
    ...
    $map.height(height);
    return $('#directions-panel').height(height);
  };
  ...
  initializeGoogleMaps = function() {
    ...
    return google.maps.event.addListener(map.getStreetView(), 'visible_changed', function() {
      if (!this.getVisible()) {
        $map.removeClass('streetview');
        return fitMapBewteenHeaderAndFooter();
      }
    });
  };
