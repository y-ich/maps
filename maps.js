...
(function() {
  var $addressField, $destinationField, $gps, $map, $message, $originField, $pinList, DEFAULT_ICON_SIZE, MSMARKER_SHADOW, MapFSM, MapState, MarkerWithCircle, MobileInfoWindow, PURPLE_DOT_IMAGE, Place, RED_DOT_IMAGE, bookmarkContext, bookmarks, currentPlace, directionsRenderer, droppedPlace, generateBookmarkList, generateHistoryList, geocoder, getLocalizedString, getMapType, getTravelMode, history, infoWindow, initializeDOM, initializeGoogleMaps, isHold, localize, map, mapFSM, mapSum, maxHistory, meterToString, method, name, naviMarker, navigate, ordinal, panoramioLayer, pinRowHeight, placeContext, saveMapStatus, saveOtherStatus, scrollLeft, searchAddress, searchDirections, searchPlace, secondToString, setInfoPage, setLocalExpressionInto, sum, tracer, trafficLayer, updateField, updateMessage, _ref, _ref1, _ref2, _ref3, _ref4,
