...
(function() {
  var $addressField, $destinationField, $gps, $map, $originField, $pinList, Bookmark, DEFAULT_ICON_SIZE, MSMARKER_SHADOW, MapFSM, MapState, MarkerWithCircle, MobileInfoWindow, PURPLE_DOT_IMAGE, RED_DOT_IMAGE, bookmarkContext, bookmarks, currentBookmark, currentLocationMarker, directionsRenderer, droppedBookmark, generateBookmarkList, generateHistoryList, geocoder, getArriveAtMessage, getDepartAtMessage, getLocalizedString, getMapType, getPanoramaHandler, getTravelMode, history, infoWindow, initializeDOM, initializeGoogleMaps, isHold, localize, map, mapFSM, mapSum, maxHistory, meterToString, method, name, naviMarker, navigate, pinRowHeight, saveMapStatus, saveOtherStatus, searchAddress, searchBookmark, searchDirections, secondToString, setInfoPage, setLocalExpressionInto, sum, tracer, updateField, updateMessage, _ref, _ref1, _ref2, _ref3, _ref4,
