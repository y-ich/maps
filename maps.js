    ...
    $travelMode.children().on('click', function() {
      ...
      switch ($this.attr('id')) {
        ...
        case 'transit':
          ...
          return transitLayer.setMap(map);
        case 'walking':
          transitLayer.setMap(null);
