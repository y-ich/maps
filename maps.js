...
(function() {
  ...
  searchAddress = function(fromHistory) {
    var address, e, equations, match, pair, parameters, _i, _len, _ref5;
    address = $addressField.val();
