...
(function() {
  ...
  initializeDOM = function() {
    ...
    $map.on('click', '#street-view', function(event) {
      return new google.maps.StreetViewService().getPanoramaByLocation(placeContext.marker.getPosition(), 49, getPanoramaHandler);
    });
