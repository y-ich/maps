...
(function() {
  var $addressField, $destinationField, $gps, $map, $message, $originField, $pinList, DEFAULT_ICON_SIZE, MSMARKER_SHADOW, MapFSM, MapState, MarkerWithCircle, MobileInfoWindow, PURPLE_DOT_IMAGE, Place, RED_DOT_IMAGE, autoAddressField, autoDestinationField, autoOriginField, bicycleLayer, bookmarkContext, bookmarks, centerBeforeSV, currentPlace, directionsRenderer, droppedPlace, fusionLayer, generateBookmarkList, generateHistoryList, geocoder, getLocalizedString, getMapType, getTravelMode, history, infoWindow, initializeDOM, initializeGoogleMaps, isHold, kmlLayer, localize, map, mapFSM, mapSum, maxHistory, meterToString, method, name, naviMarker, navigate, norikaeServices, ordinal, panoramioLayer, parseQuery, pinRowHeight, placeContext, prepareKmlLayer, restoreStatus, saveMapStatus, saveOtherStatus, scrollLeft, searchAddress, searchDirections, searchPlace, secondToString, setInfoPage, setLocalExpressionInto, setRouteMap, setSearchResult, style, sum, tracer, tracer2State, trafficLayer, transitLayer, updateField, updateMessage, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  norikaeServices = [['MapFan+', 'mapfanplus:', '', ''], ['乗換ナビ', 'navitimetransfer:', '', ''], ['乗換案内', 'NrkjFree:', '', ''], ['Yahoo! ロコ 乗換案内', 'yjtransit:'], ['駅.Locky', 'com.ubigraph.ekilocky:'], ['Google乗換案内', 'https://www.google.co.jp/maps?ie=UTF8&f=d&dirflg=r&', 'saddr', 'daddr'], ['ジョルダン', 'http://www.jorudan.co.jp/norikae/cgi/nori.cgi?', 'eki1', 'eki2']];
  ...
  prepareKmlLayer = function(address) {
    if (kmlLayer != null) {
  ...
  searchAddress = function(fromHistory) {
    var address, match, parameters, _ref5;
    address = $addressField.val();
    ...
    if (match = address.match(/^fusion:(.*)/)) {
      ...
      return prepareKmlLayer(address);
    } else {
  ...
  restoreStatus = function() {
    var e, otherStatus, _i, _len, _ref5, _ref6, _ref7;
    if (localStorage['maps-other-status'] != null) {
      ...
      return history = (_ref7 = otherStatus.history) != null ? _ref7 : [];
    }
  };
