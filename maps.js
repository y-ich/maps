...
(function() {
  ...
  PulsatingMarker = (function(_super) {

    __extends(PulsatingMarker, _super);

    function PulsatingMarker(options) {
      var _ref;
      PulsatingMarker.__super__.constructor.call(this, options);
      this.pulse = new google.maps.Circle({
        center: options.position,
        clickable: false,
        visible: (_ref = options.visible) != null ? _ref : true
      });
    }

    PulsatingMarker.prototype.setPosition = function(latLng) {
      PulsatingMarker.__super__.setPosition.call(this, latLng);
      return this.pulse.setCenter(latLng);
    };

    PulsatingMarker.prototype.setVisible = function(visible) {
      PulsatingMarker.__super__.setVisible.call(this, visible);
      return this.pulse.setVisible(visible);
    };

    PulsatingMarker.prototype.setMap = function(map) {
      PulsatingMarker.__super__.setMap.call(this, map);
      return this.pulse.setMap(map);
    };

    PulsatingMarker.prototype.setRadius = function(radius) {
      return this.pulse.setRadius(radius);
    };

    return PulsatingMarker;
