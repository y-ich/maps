...
(function() {
  var APP_NAME, CLIENT_ID, DirectionsController, Event, LOCAL_CALENDAR, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, calendars, compareEventResources, currentCalendar, currentPlace, directionsCondition, directionsController, findCalendarById, getLocalizedString, getTimeZone, handleAuthResult, initializeDOM, initializeGoogleMaps, localTime, localize, map, mapSum, saveMapStatus, searchDirections, setLocalExpressionInto, spinner, sum, timeDifference,
  ...
  initializeDOM = function() {
    ...
    $('#button-show').on('click', function() {
      var e, event, events, i, id, name, options, req, time, timeMax, timeMin, _i, _len, _results;
