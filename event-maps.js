...
(function() {
  var CLIENT_ID, Event, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, calendars, compareEventResources, currentCalendar, currentEvent, geocoder, getLocalizedString, getTimeZone, handleAuthResult, initializeDOM, initializeGoogleMaps, localTime, localize, map, saveMapStatus, setLocalExpressionInto, spinner, timeDifference,
    _this = this,
  ...
  initializeDOM = function() {
    ...
    return $('#button-prev, #button-next').on('click', function(event) {
      var index, sorted, _ref;
      sorted = Event.events.sort(function(x, y) {
        return compareEventResources(x.resource, y.resource);
      });
      index = currentEvent != null ? sorted.indexOf(currentEvent) : 0;
      ...
      return map.setCenter(((_ref = currentEvent.place) != null ? _ref : currentEvent.candidates[0]).getPosition());
    });
  };
