...
(function() {
  var APP_NAME, CLIENT_ID, Event, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, calendars, compareEventResources, currentCalendar, currentPlace, directions, directionsCondition, directionsRenderer, geocoder, getLocalizedString, getTimeZone, handleAuthResult, initializeDOM, initializeGoogleMaps, localTime, localize, map, mapSum, saveMapStatus, searchDirections, setLocalExpressionInto, spinner, sum, timeDifference,
    _this = this,
    ...
    function Place(options, event, candidateAddress) {
      ...
      google.maps.event.addListener(this, 'click', function() {
        ...
        if ((directionsCondition.origin != null) && (directionsCondition.destination == null)) {
          ...
          return searchDirections(directionsCondition.origin.getPosition(), _this.getPosition(), time, function(results) {
