...
(function() {
  var APP_NAME, CLIENT_ID, DirectionsController, Event, LOCAL_CALENDAR, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, authorizeStatus, calendars, compareEventResources, currentPlace, directionsCondition, directionsController, findCalendarById, getLocalizedString, getTimeZone, handleAuthResult, initializeDOM, initializeGoogleMaps, localCalendar, localTime, localize, map, mapSum, saveMapStatus, searchDirections, setLocalExpressionInto, spinner, sum, timeDifference,
