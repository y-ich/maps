...
(function() {
  var APP_NAME, CLIENT_ID, Event, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, calendars, compareEventResources, currentCalendar, currentPlace, directions, directionsRenderer, geocoder, getLocalizedString, getTimeZone, handleAuthResult, initializeDOM, initializeGoogleMaps, localTime, localize, map, mapSum, modalPlace, originPlace, saveMapStatus, searchDirections, setLocalExpressionInto, spinner, sum, timeDifference,
    _this = this,
  ...
  initializeDOM = function() {
    ...
    return $('#button-search').on('click', function(event) {
      ...
      modalPlace.event.clearMarkers();
      if ((_ref = modalPlace.event.resource.extendedProperties) != null) {
