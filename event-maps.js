...
(function() {
  var APP_NAME, CLIENT_ID, DirectionsController, Event, MAP_STATUS, Place, SCOPES, TIME_ZONE_HOST, calendars, compareEventResources, currentPlace, directionsCondition, directionsController, findCalendarById, getLocalizedString, getTimeZone, handleAuthResult, initializeDOM, initializeGoogleMaps, localCalendar, localTime, localize, map, mapSum, saveMapStatus, searchDirections, setLocalExpressionInto, spinner, sum, timeDifference,
  ...
  initializeDOM = function() {
    ...
    $('#button-show').on('click', function() {
      var currentCalendar, id, name, options, req;
      ...
      if (id === 'new') {
        ...
        return req.execute(function(resp) {
          var e, event, i, _i, _len, _ref, _ref1, _results;
          if (resp.error != null) {
            return console.error(resp);
